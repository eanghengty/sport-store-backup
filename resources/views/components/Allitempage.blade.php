...
import Item from "../includes/partial/Item";
import './../styles/allitempage.scss'
import { FaDotCircle } from 'react-icons/fa'
import naga from './../images/Clubs/NAGA.png'
import nagacover from './../images/Banner/nagacover.jpg'
const Allitempage=()=>{
    return(
        <div>
            <Header/>
            <div class="allitempage2">
                ...
                <div class="allitempagelist"></div>
                    <div class="allitempagelist list1">
                       <div class="allitemicon2"><i class="fa fa-circle-o allitempageicon" aria-hidden="true"></i></div> 
                ...
                <div className="allitempage5">
                    ...
                    <div class="allitempage7">
                        <img src="{{asset('/images/Clubs/nagacover.png')}}" alt="banner2" />
                    </div>
